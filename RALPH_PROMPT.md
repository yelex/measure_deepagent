...
- L001 (фикс grounding bug) — **done**, пропусти.
- **Текущий приоритет (14.08): L010** — category static lookup (сво/инвалиды).
- После L010: L016 (промпт measureTerms), L012 (sum инвалиды), L005 (реестр).
- Бери задачу с наивысшим приоритетом в статусе `todo`.
