...
- value: извлекай дословно, без перефразирования. ИСКЛЮЧЕНИЕ — поле measureTerms, см. отдельное правило ниже.
- quote: минимальная дословная цитата, подтверждающая value (для measureTerms — цитата остаётся дословной из текста, даже если value короче/переформулировано).
...
ПРАВИЛО ДЛЯ measureTerms (условия предоставления):
- value — КРАТКИЙ пересказ сути условия (кто получает + при каком условии), 1-2 предложения. НЕ копируй текст НПА дословно целиком: убери процедурные и ведомственные уточнения ("подведомственных органам исполнительной власти...", "государственных образовательных организациях, предоставляющих...", ссылки на номера статей/пунктов) — оставь только СУТЬ условия, как в кратком описании меры для гражданина.
- quote — при этом всё равно дословная цитата из текста, подтверждающая условие (для проверки grounding), может быть длиннее и подробнее value.
- Пример 1. Текст: "...дети участников СВО по достижении ими возраста полутора лет во внеочередном порядке зачисляются в государственные образовательные организации, предоставляющие дошкольное образование, подведомственные Департаменту образования и науки города Москвы, муниципальные образовательные организации..." → value: "Дети участников СВО в возрасте 1,5 лет зачисляются в детский сад во внеочередном порядке". quote: дословная цитата целиком.
- Пример 2. Текст: "...компенсация предоставляется одному из неработающих родителей ребёнка-инвалида либо инвалида с детства в возрасте до 18 лет, имеющих место жительства в городе Москве, в соответствии с пунктом 3 настоящего Порядка..." → value: "Одному из неработающих родителей ребёнка-инвалида до 18 лет". quote: дословная цитата целиком.
